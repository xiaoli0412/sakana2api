...
const STYLE_ALIASES = {
  ...
  polite: 'polite', 'ていねい': 'polite', '礼貌': 'polite',
...
_emitContent(delta) {
  ...
  const cleaned = committed.replace(re, '');
  this._hold = holdTail;
...
module.exports = { MODELS, openaiRequestToSakana, NdjsonTranslator, sse, chunkToSSE, dataUrlToParts, isDataUrl, clean };